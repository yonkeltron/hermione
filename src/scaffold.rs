...
impl Scaffold {
    ...
    pub fn new(package_name: &str, package_id: &str) -> Self {
        ...
        Self {
            ...
            manifest: Manifest {
                ...
                hooks: Some(Hooks {
                    pre_install_file: Some(String::from("pre_install_hook.ds")),
                    post_install_file: Some(String::from("post_install_hook.ds")),
                }),
            },
        }
    }
    ...
    fn create_example_files(&self, logger: &Logger) -> Result<()> {
        ...
        sample_files.insert("pre_install_hook.ds", "echo Hello From Pre Install Hook");
        sample_files.insert("post_install_hook.ds", "echo Hello From Post Install Hook");
